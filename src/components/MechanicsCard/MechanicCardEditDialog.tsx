                                ...
                                <div className="px-4 py-3 grid-cols-1 place-content-center place-items-center gap-y-8">
                                    <Form>
                                        <Box maxH={"60vh"} overflowY={"auto"}>
                                            <Input mt={4} placeholder='Nome da mecânica' defaultValue={mechanicName}></Input>
                                            <Textarea resize={"vertical"} maxH={"200px"} minH={"40px"} mt={4} placeholder='Qual é o objetivo desta mecânica?' defaultValue={mechanicDesc}></Textarea>
                                            ...
                                            <Input mt={2} defaultValue={mechanicActions} placeholder='Atacar,Defender,Usar item,Usar feitiço,Outro'></Input>
                                            ...
                                            <Input mt={2} defaultValue={mechanicReactions} placeholder='Desviou,Machucado,Desmaiado,Enfeitiçado,Outro'></Input>
                                        </Box>
                                    </Form>
                                    <Button mt={"4"} mb={"4"}>Salvar Mecânica</Button>
                                </div>
