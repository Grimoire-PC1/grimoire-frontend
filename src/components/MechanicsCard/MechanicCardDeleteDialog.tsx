...
import { deleteMechanic } from '@/services/systemService';
...
export const MechanicCardDeleteDialog = ({
    open,
    handleClose,
    handleConfirm,
    mechanicId,
                            ...
                            >
                                ...
                                <div className="sm:flex sm:items-start">
                                    ...
                                    <DialogTitle className="text-base text-large font-semibold">
                                        Tem certeza que deseja deletar {mechanicName}?
                                    </DialogTitle>
                                    </div>
                                </div>
                                </div>
                                <div className="px-4 py-3 grid-cols-1 place-content-center place-items-center gap-y-8">
                                    ...
                                    <Button onClick={()=>mutation.mutate(mechanicId)} mt={"4"} mb={"4"}>Deletar Mecânica</Button>
                                </div>
