...
export const SoundtrackDeleteFieldDialog = ({
    open,
    handleClose,
    handleConfirm,
    fieldId,
    ...
    const mutation = useMutation({
        ...
        onError: (error) => {
            console.log(error);
            toaster.create({
                        description: "Houve um problema durante a deleção da música.",
                        type: "error",
                        })
        },
    });
                        ...
                        <Box className="rounded-lg" bg={{ base: "white", _dark: "black" }} color={{ base: "black", _dark: "white" }} >
                            ...
                            >
                                ...
                                <div className="sm:flex sm:items-start">
                                    ...
                                    Tem certeza que deseja deletar esta música da playlist?
                                    </DialogTitle>
                                    </div>
                                </div>
                                </div>
                                <div className="px-4 py-3 grid-cols-1 place-content-center place-items-center gap-y-8">
                                    ...
                                    <Link mt={4} target="_blank" href={fieldName}>{fieldName}</Link>
                                    ...
                                    <Button onClick={()=>mutation.mutate(fieldId)} mt={"4"} mb={"4"}>Deletar Música</Button>
                                </div>
