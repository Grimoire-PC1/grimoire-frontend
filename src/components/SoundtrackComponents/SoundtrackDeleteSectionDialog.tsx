...
export const SoundtrackDeleteSectionDialog = ({
    open,
    handleClose,
    handleConfirm,
    sectionId,
    ...
    const mutation = useMutation({
        ...
        onError: (error) => {
            console.log(error);
            toaster.create({
                        description: "Houve um problema durante a deleção da playlist.",
                        type: "error",
                        })
        },
    });
                        ...
                        <Box className="rounded-lg" bg={{ base: "white", _dark: "black" }} color={{ base: "black", _dark: "white" }} >
                            ...
                            >
                                ...
                                <div className="sm:flex sm:items-start">
                                    ...
                                    Tem certeza que deseja deletar {sectionName}?
                                    </DialogTitle>
                                    </div>
                                </div>
                                </div>
                                <div className="px-4 py-3 grid-cols-1 place-content-center place-items-center gap-y-8">
                                    ...
                                    <Button onClick={()=>mutation.mutate(sectionId)} mt={"4"} mb={"4"}>Deletar Playlist</Button>
                                </div>
