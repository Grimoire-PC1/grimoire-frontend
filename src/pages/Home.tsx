            ...
            <Box h={"100vh"} overflowY={"hidden"} bg={{ base: "white", _dark: "black" }} color={{ base: "black", _dark: "white" }} >
                ...
                <Dialog open={openDialogSm} onClose={setOpenDialogSm} className="relative z-10">
                    ...
                    <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                        ...
                        <Box placeContent={"center"} placeItems={"center"} justifyContent={"center"} justifyItems={"center"} className="rounded-lg" bg={{ base: "white", _dark: "black" }} color={{ base: "black", _dark: "white" }} >
                            <DialogPanel
                                transition
